# -*- coding: utf-8 -*-
# Generated by Django 1.9.3 on 2016-03-26 00:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('upvotes', models.IntegerField(default=1)),
                ('start_time', models.DateTimeField(default=datetime.datetime(2016, 3, 26, 0, 16, 14, 741789))),
                ('end_time', models.DateTimeField(default=datetime.datetime(2016, 3, 26, 0, 16, 14, 741824))),
                ('minutes', models.IntegerField(default='1')),
                ('seconds', models.IntegerField(default='1')),
